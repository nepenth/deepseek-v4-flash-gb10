...
class RuntimeContractTests(unittest.TestCase):
    ...
    def test_cluster_canary_preserves_first_light_contract(self) -> None:
        ...
        self.assertIn("v0.27.1-gb10-rc7", profile)
        self.assertIn("v0.27.1-gb10-rc7", example)
    ...
    def test_deepgemm_router_counter_warmup_patch_is_included(self) -> None:
        ...
        self.assertIn("(1, 2, 3, 6, 8, 11, 16, 22, 24, 43, 48, 86, 88)", patch)
        self.assertIn("_FUSED_MOE_TOKEN_COUNTER_RUNTIME_DIVISIBILITY", patch)
